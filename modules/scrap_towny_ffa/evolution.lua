...
local technology_weights = {
    ['active-defense']={biter=5, spitter=5, worm=5},
    ...
    ['analyse-ship']={biter=1, spitter=1, worm=1},
    ...
    ['basic-electronics']={biter=1, spitter=1, worm=1},
    ['basic-logistics']={biter=1, spitter=1, worm=1},
    ['basic-mapping']={biter=1, spitter=1, worm=1},
    ['basic-military']={biter=5, spitter=5, worm=5},
    ['basic-mining']={biter=1, spitter=1, worm=1},
    ['basic-optics']={biter=1, spitter=1, worm=1},
    ...
    ['chemical-science-pack']={biter=1, spitter=1, worm=1},
    ...
    ['combat-robotics']={biter=5, spitter=5, worm=5},
    ['combat-robotics-2']={biter=5, spitter=5, worm=5},
    ['combat-robotics-3']={biter=5, spitter=5, worm=5},
    ['concrete']={biter=1, spitter=1, worm=1},
    ['construction-robotics']={biter=1, spitter=1, worm=1},
    ['demo-automation-upgrade']={biter=1, spitter=1, worm=1},
    ['demo-gates']={biter=1, spitter=1, worm=1},
    ['demo-logistics']={biter=1, spitter=1, worm=1},
    ['demo-military-equipment']={biter=5, spitter=5, worm=5},
    ['demo-munitions-upgrade']={biter=5, spitter=5, worm=5},
    ['demo-productivity-1']={biter=1, spitter=1, worm=1},
    ['demo-science-pack']={biter=1, spitter=1, worm=1},
    ['demo-shooting-speed-1']={biter=5, spitter=5, worm=5},
    ['demo-shooting-speed-4']={biter=5, spitter=5, worm=5},
    ['demo-steel-furnace']={biter=1, spitter=1, worm=1},
    ['demo-steel-poles']={biter=1, spitter=1, worm=1},
    ['demo-steel-processing']={biter=1, spitter=1, worm=1},
    ...
    ['electric-inserter']={biter=1, spitter=1, worm=1},
    ['electric-mining']={biter=1, spitter=1, worm=1},
    ...
    ['gates']={biter=1, spitter=1, worm=1},
    ...
    ['laser-turrets']={biter=5, spitter=5, worm=5},
    ['logistic-robotics']={biter=1, spitter=1, worm=1},
    ['logistic-science-pack']={biter=1, spitter=1, worm=1},
    ...
    ['military-science-pack']={biter=5, spitter=5, worm=5},
    ...
    ['passive-defense']={biter=5, spitter=5, worm=5},
    ...
    ['production-science-pack']={biter=1, spitter=1, worm=1},
    ...
    ['radar']={biter=1, spitter=1, worm=1},
    ...
    ['repair-tech']={biter=1, spitter=1, worm=1},
    ...
    ['space-science-pack']={biter=1, spitter=1, worm=1},
    ...
    ['stone-walls']={biter=1, spitter=1, worm=1},
...
local function get_relative_biter_evolution(position)
    ...
    local teams = global.towny.town_centers
...
local function update_evolution(force_name, technology)
    ...
    local worm_weight = technology_weights[technology].worm
