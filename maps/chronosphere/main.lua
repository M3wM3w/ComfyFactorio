...
global.difficulty_tooltips = {
    ...
    [4] = "Normal difficulty.",
    [5] = "Biters more aggressive; time evo faster; pollution by train higher; maps less favourable; upgrades coin prices slightly more expensive; flamer nerf less slight",
    [6] = "Biters much more aggressive; time evo significantly faster; pollution by train significantly higher; maps significantly less favourable; upgrades coin prices more expensive; flamer nerf less slight",
