...
function Public.upgrades()
  ...
  local upgrades = {
    ...
    [2] = {
      ...
      tooltip = {"chronosphere.upgrade_filter_tooltip", math_floor(100 * Balance.pollution_transfer_from_inside_factor(global.difficulty_vote_value, objective.upgrades[2]))},
