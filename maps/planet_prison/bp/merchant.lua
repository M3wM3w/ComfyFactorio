local bp = {
    entities = {
        {entity_number = 1, name = "stone-wall", position = {x = -3, y = -4}},
        {entity_number = 2, name = "stone-wall", position = {x = -1, y = -4}},
        {entity_number = 3, name = "stone-wall", position = {x = -2, y = -4}},
        {entity_number = 4, name = "stone-wall", position = {x = 1, y = -4}},
        {entity_number = 5, name = "stone-wall", position = {x = 0, y = -4}},
        {entity_number = 6, name = "stone-wall", position = {x = 3, y = -4}},
        {entity_number = 7, name = "stone-wall", position = {x = 2, y = -4}},
        {entity_number = 8, name = "stone-wall", position = {x = 4, y = -4}},
        {entity_number = 9, name = "stone-wall", position = {x = -5, y = -2}},
    ...
    tiles = {
        ...
        {position = {x = 2, y = 1}, name = "concrete"},
        {position = {x = 2, y = 2}, name = "concrete"},
        {position = {x = 3, y = -3}, name = "hazard-concrete-left"},
        {position = {x = 3, y = -2}, name = "hazard-concrete-left"},
        {position = {x = 3, y = -1}, name = "concrete"},
        {position = {x = 3, y = 0}, name = "concrete"},
        {position = {x = 3, y = 1}, name = "concrete"},
