...
public.player_ship_loot = {
    ...
    {name = "grenade", count = 2}, {name = "submachine-gun", count = 1},
    {name = "light-armor", count = 1}, {name = "iron-plate", count = 30},
    {name = "copper-plate", count = 10}, {name = "raw-fish", count = 2},
    {name = "small-lamp", count = 1}
}

public.permission_orbit = {
    defines.input_action.activate_copy, defines.input_action.activate_cut,
    defines.input_action.activate_paste,
    defines.input_action.add_permission_group,
    defines.input_action.add_train_station, defines.input_action.admin_action,
    defines.input_action.alt_select_area,
    defines.input_action.alt_select_blueprint_entities,
    defines.input_action.alternative_copy, defines.input_action.begin_mining,
    defines.input_action.begin_mining_terrain, defines.input_action.build_item,
    defines.input_action.build_rail, defines.input_action.build_terrain,
    defines.input_action.cancel_craft, defines.input_action.cancel_deconstruct,
    defines.input_action.cancel_new_blueprint,
    defines.input_action.cancel_research, defines.input_action.cancel_upgrade,
    ...
    defines.input_action.copy_entity_settings, defines.input_action.craft,
    defines.input_action.create_blueprint_like,
    defines.input_action.cursor_split, defines.input_action.cursor_transfer,
    ...
    defines.input_action.drop_blueprint_record, defines.input_action.drop_item,
    ...
    defines.input_action.inventory_transfer, defines.input_action.launch_rocket,
    defines.input_action.lua_shortcut, defines.input_action.map_editor_action,
    ...
    defines.input_action.open_equipment, defines.input_action.open_gui,
    defines.input_action.open_item, defines.input_action.open_kills_gui,
    defines.input_action.open_logistic_gui, defines.input_action.open_mod_item,
    ...
    defines.input_action.quick_bar_set_slot, defines.input_action.remove_cables,
    defines.input_action.remove_train_station,
    defines.input_action.reset_assembling_machine,
    defines.input_action.rotate_entity, defines.input_action.select_area,
    defines.input_action.select_blueprint_entities,
    defines.input_action.select_entity_slot, defines.input_action.select_item,
    ...
    defines.input_action.smart_pipette, defines.input_action.stack_split,
    defines.input_action.stack_transfer, defines.input_action.start_repair,
    ...
    defines.input_action.translate_string, defines.input_action.undo,
    defines.input_action.upgrade, defines.input_action.upgrade_opened_blueprint,
    defines.input_action.use_artillery_remote, defines.input_action.use_item,
    defines.input_action.wire_dragging
}

public.self_explode = 60 * 60 * 10 -- time until main shipwreck explosion
public.claim_markers = {"gun-turret", "laser-turret", "stone-wall"}
...
public.raid_costs = {
    {
        ...
        chance = 300,
        gear = {
            {weap = "shotgun", ammo = "shotgun-shell", armor = "light-armor"},
            {weap = "pistol", ammo = "firearm-magazine", armor = "light-armor"}
        }
    }, {
        cost = 15,
        chance = 150,
        ...
        chance = 100,
        gear = {
            {weap = "shotgun", ammo = "shotgun-shell", armor = "heavy-armor"},
            {weap = "pistol", ammo = "firearm-magazine", armor = "heavy-armor"}
        }
    }, {
        cost = 70,
        chance = 100,
...
public.wreck_loot = {
    ["iron-plate"] = {rare = 0.1, count = {20, 40}},
    ["copper-plate"] = {rare = 0.1, count = {10, 30}},
    ["empty-barrel"] = {rare = 0.4, count = {1, 1}},
    ["copper-cable"] = {rare = 0.5, count = {5, 20}},
    ["electronic-circuit"] = {rare = 0.6, count = {5, 20}},
    ["firearm-magazine"] = {rare = 0.4, count = {1, 2}},
    ["steel-plate"] = {rare = 0.8, count = {1, 5}},
    ["explosives"] = {rare = 0.85, count = {1, 5}},
    ["advanced-circuit"] = {rare = 0.9, count = {1, 5}},
    ["processing-unit"] = {rare = 0.95, count = {1, 2}},
    ["electric-engine-unit"] = {rare = 0.95, count = {1, 1}},
    ["battery"] = {rare = 0.95, count = {1, 2}},
    ["piercing-rounds-magazine"] = {rare = 0.99, count = {1, 2}}
}
...
public.merchant_offer = {
    {
        ...
        price = {{type = "item", name = "coin", amount = 100}},
        offer = {type = "give-item", item = "heavy-armor"}
    }, {
        price = {{type = "item", name = "coin", amount = 500}},
        offer = {type = "give-item", item = "modular-armor"}
    }, {
        price = {{type = "item", name = "coin", amount = 12000}},
        offer = {type = "give-item", item = "power-armor"}
    }, {
        price = {{type = "item", name = "coin", amount = 100}},
        offer = {type = "give-item", item = "night-vision-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 70}},
        offer = {type = "give-item", item = "battery-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 700}},
        offer = {type = "give-item", item = "battery-mk2-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 1200}},
        offer = {type = "give-item", item = "exoskeleton-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 2500}},
        offer = {type = "give-item", item = "fusion-reactor-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 200}},
        offer = {type = "give-item", item = "personal-roboport-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 400}},
        offer = {type = "give-item", item = "personal-roboport-mk2-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 90}},
        offer = {type = "give-item", item = "solar-panel-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 300}},
        offer = {type = "give-item", item = "energy-shield-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 2000}},
        offer = {type = "give-item", item = "energy-shield-mk2-equipment"}
    }, {
        price = {{type = "item", name = "coin", amount = 50}},
        offer = {type = "give-item", item = "flamethrower-ammo"}
    }, {
        price = {{type = "item", name = "coin", amount = 1}},
        offer = {type = "give-item", item = "firearm-magazine"}
    }, {
        price = {{type = "item", name = "coin", amount = 5}},
        offer = {type = "give-item", item = "piercing-rounds-magazine"}
    }, {
        price = {{type = "item", name = "coin", amount = 1000}},
        offer = {type = "unlock-recipe", recipe = "flamethrower"}
    }, {
        price = {{type = "item", name = "coin", amount = 50}},
        offer = {type = "give-item", item = "defender-capsule"}
    }, {
        price = {{type = "item", name = "coin", amount = 200}},
        offer = {type = "give-item", item = "distractor-capsule"}
    }, {
        price = {{type = "item", name = "coin", amount = 250}},
        offer = {type = "give-item", item = "destroyer-capsule"}
    }, {
        price = {{type = "item", name = "coin", amount = 70}},
        offer = {type = "unlock-recipe", recipe = "filter-inserter"}
    }, {
        price = {{type = "item", name = "coin", amount = 100}},
        offer = {type = "unlock-recipe", recipe = "stack-inserter"}
    }, {
